...
/**
 * Export dropdown button — offers CSV and Excel download options.
...
function ExportButton({ transactions }) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {open && (
        <div className="absolute right-0 mt-1.5 w-44 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50 animate-in fade-in zoom-in-95 duration-100">
          <button
            onClick={handleCSV}

...
## MCP, SKills, Agents
### MCP
- Superbase MCP connected
- DB schemma check directly
- Query/insert/migrate
- claude queires DB live
...
### Agents
- db-agent --> DB --> hooks
- fronted-agent --> UI -->pages
- validator-agent --> forms
- ai-agent --> AI Advisor
...
**Tech stack:** React · TypeScript · Vite · Tailwind CSS v4 · TanStack Query · Supabase (Auth, Postgres, Realtime, Storage)
(20 seconds)
